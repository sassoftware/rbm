...
<body>
    ...
    function convertNow(link)
    {
        ...
        messageBox.doDisplay(
            "This process may take up to an hour, during which time your repository will not be available.  Please make sure you have a recent backup before continuing.  Do you really want to convert this repository?",
    ...
    <div py:if="not running and not converted" id="conv_instructions">
        ...
        <h5>Clicking the "Convert" button below will convert your Update
        Service Repository to use PostgreSQL as its backend database.
        ...
        scheduled.  The conversion process will take an hour or less on most
        systems, and is reversible if an error occurs, but rPath suggests
        ...
        complete.  Check your repository for completeness and
    ...
    <!--<div py:if="not running" id="conv_instructions">-->
        ...
        change permanent, and remove the old database.  Once you have
